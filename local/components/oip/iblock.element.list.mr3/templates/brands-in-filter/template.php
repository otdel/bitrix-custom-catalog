...
<?else:?>
    ...
    <?if($elements):?>
        <div class="uk-inline">
                ...
                <form>
                    <ul class="uk-nav uk-dropdown-nav" id="oip-filter-brands-container">
                        ...
                        <li class="uk-text-center">
                            <a class="uk-button uk-button-link uk-button-small" href="javascript:void(0)" 
                               id="oip-filter-brands-apply" data-filter-id="<?=$filterId?>">Выбрать</a>
                        </li>
            ...
            <?if($isBrandsSelected):?>
                <i class="uk-icon-button uk-margin-small-left" uk-icon="close" id="oip-filter-brands-reset"
